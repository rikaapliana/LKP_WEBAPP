...
// Ambil data siswa dengan validasi bahwa siswa ada di kelas yang diampu instruktur
$query = "SELECT s.*, u.username, u.role, k.nama_kelas, g.nama_gelombang, i.nama as nama_instruktur
          FROM siswa s 
...
mysqli_stmt_bind_param($stmt, "ii", $id_siswa, $id_instruktur);
mysqli_stmt_execute($stmt);
$result = mysqli_stmt_get_result($stmt);

if (mysqli_num_rows($result) == 0) {
    $_SESSION['error'] = "Data siswa tidak ditemukan atau bukan siswa yang Anda ampu!";
    header("Location: index.php");
    exit;
}
            ...
            <div class="col">
              <div class="d-flex justify-content-between align-items-start">
                ...
                <div class="d-flex gap-3">
                  ...
                  <a href="../nilai/index.php?siswa=<?= $siswa['id_siswa'] ?>" class="btn btn-primary px-4">
      ...
      <div class="row">
              ...
              <div class="row g-4">
                ...
                <div class="col-md-6">
                  <div class="info-item">
                    ...
                    <div class="fw-medium"><?= $siswa['tanggal_lahir'] ? date('d F Y', strtotime($siswa['tanggal_lahir'])) : '-' ?></div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="info-item">
        ...
        <div class="col-lg-4">
          ...
          <div class="card content-card">
            <div class="section-header">
              <h5 class="mb-0 text-dark">
                <i class="bi bi-info-circle me-2"></i>Info Kelas
              </h5>
            </div>
            <div class="card-body">
              <!-- Info Kelas -->
              <div class="mb-4">
                <h6 class="fw-bold mb-3">
                  <i class="bi bi-building me-2"></i>Kelas & Instruktur
                </h6>
                <?php if($siswa['nama_kelas']): ?>
                  <div class="text-center p-3">
                    ...
                    <small class="text-muted d-block">Gelombang: <?= htmlspecialchars($siswa['nama_gelombang'] ?? '-') ?></small>
                    <small class="text-info d-block">Instruktur: <?= htmlspecialchars($siswa['nama_instruktur'] ?? '-') ?></small>
                  </div>
                <?php else: ?>
                  <div class="text-center p-3">
                    <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
