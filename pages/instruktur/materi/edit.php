...
if (isset($_POST['ajax_check_duplicate'])) {
    ...
    // Cek duplikasi dalam scope instruktur ini (exclude current materi)
    $duplicateQuery = "SELECT m.id_materi, m.judul, k.nama_kelas 
                       ...
                       AND k.id_instruktur = '$id_instruktur'";
...
// Ambil data kelas yang diampu instruktur ini untuk dropdown
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !isset($_POST['ajax_check_duplicate'])) {
    ...
    if (!empty($_FILES['file_materi']['name'])) {
        ...
        if (!in_array($fileExtension, $allowedExtensions)) {
            ...
            if (move_uploaded_file($fileTmp, $uploadPath)) {
                ...
                $file_materi = $materi['file_materi']; // Kembalikan ke file lama jika gagal
    ...
    if (!isset($error)) {
        // Validasi kelas jika dipilih - harus milik instruktur ini
        if ($id_kelas) {
            $kelasCheck = $conn->prepare("SELECT nama_kelas FROM kelas WHERE id_kelas = ? AND id_instruktur = ?");
            $kelasCheck->bind_param("ii", $id_kelas, $id_instruktur);
            $kelasCheck->execute();
            $kelasCheckResult = $kelasCheck->get_result();
            
            if ($kelasCheckResult->num_rows == 0) {
                $error = "Kelas tidak valid atau bukan kelas yang Anda ampu!";
            }
        }
        
        // Validasi duplikasi materi (judul + id_kelas harus unik dalam scope instruktur, exclude current materi)
        if (!isset($error) && $id_kelas) {
            ...
            $duplicateStmt->bind_param("siii", $judul, $id_kelas, $id_materi, $id_instruktur);
            $duplicateStmt->execute();
            $duplicateResult = $duplicateStmt->get_result();
            
            if ($duplicateResult->num_rows > 0) {
                $existingMateri = $duplicateResult->fetch_assoc();
        ...
        if (!isset($error)) {
            ...
            try {
                // Update data materi - instruktur tetap sama (tidak diubah)
                ...
                $stmt->bind_param("ssisi", $judul, $deskripsi, $id_kelas, $file_materi, $id_materi);
                ...
                // Redirect ke index dengan filter kelas jika ada
                $redirect_url = "index.php";
                if ($id_kelas) {
                    $redirect_url .= "?kelas=" . $id_kelas;
                }
...
<head>
  ...
  <title>Edit Materi - Instruktur</title>
      ...
      <div class="container-fluid px-3 px-md-4">
        <div class="d-flex align-items-center">
          <div class="d-flex align-items-center flex-grow-1">
            ...
            <div class="page-info">
              <h2 class="page-title mb-1">EDIT MATERI</h2>
    ...
    <div class="container-fluid mt-4">
      ...
      <div class="card content-card">
        <div class="section-header">
          ...
          <small class="text-muted">ID Materi: <?= $materi['id_materi'] ?></small>
        </div>
          ...
          <form action="" method="post" enctype="multipart/form-data" id="formEditMateri">
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="mb-4">
                  ...
                  <textarea name="deskripsi" class="form-control" rows="4" required 
                            placeholder="Masukkan deskripsi materi"><?= htmlspecialchars($materi['deskripsi']) ?></textarea>
              ...
              <div class="col-lg-6">
                ...
                <div class="mb-4">
                  <label class="form-label">
                    <i class="bi bi-person-check me-1"></i>Instruktur
                  </label>
                  <input type="text" class="form-control" value="<?= htmlspecialchars($nama_instruktur) ?>" readonly>
                  <div class="form-text">
                    <i class="bi bi-info-circle me-1"></i>
                    <small>Instruktur tidak dapat diubah</small>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row mt-5">
              <div class="col-12">
                ...
                <p class="text-muted mb-4">Upload ulang file jika diperlukan. File lama akan diganti dengan file baru.</p>
                  ...
                  <div class="col-lg-6">
                    <div class="border rounded p-3" style="background-color: #f8f9fa;">
                      ...
                      <?php if(!empty($materi['file_materi'])): ?>
                        <div class="current-file mb-4 p-3 border rounded" style="background-color: #fff;">
                          <h6 class="mb-3">
                          ...
                          <div class="text-center mb-3">
                            <strong><?= htmlspecialchars($materi['file_materi']) ?></strong>
                          </div>
                          <div class="text-center mb-3">
                      ...
                      <div class="mb-3">
                        <label class="form-label">
                          <i class="bi bi-file-earmark-arrow-up me-1"></i>File Materi Baru (Opsional)
                        </label>
            ...
            <div class="row mt-5 pt-4 border-top">
              <div class="col-12">
                <div class="d-flex justify-content-end gap-3">
                  <a href="index.php<?= !empty($materi['id_kelas']) ? '?kelas=' . $materi['id_kelas'] : '' ?>" class="btn btn-kembali px-3">
                   Kembali
                  </a>
