...
// Get kelas dari URL parameter jika ada
$preselected_kelas = isset($_GET['kelas']) ? $_GET['kelas'] : '';
...
if (isset($_POST['ajax_check_duplicate'])) {
    ...
    // Cek duplikasi dalam scope kelas yang diampu instruktur ini
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !isset($_POST['ajax_check_duplicate'])) {
    ...
    if (!isset($error)) {
        ...
        // Validasi duplikasi materi (judul + id_kelas harus unik dalam scope instruktur)
        if (!isset($error) && $id_kelas) {
            ...
            $duplicateStmt->bind_param("sii", $judul, $id_kelas, $id_instruktur);
        ...
        if (!isset($error)) {
            ...
            try {
                // Insert ke database - instruktur otomatis dari yang login
                $query = "INSERT INTO materi (judul, deskripsi, id_kelas, id_instruktur, file_materi) 
                          VALUES (?, ?, ?, ?, ?)";
                
                $stmt = $conn->prepare($query);
                $stmt->bind_param("ssiss", $judul, $deskripsi, $id_kelas, $id_instruktur, $file_materi);
                ...
                if ($stmt->execute()) {
                    ...
                    throw new Exception("Gagal menambahkan materi: " . mysqli_error($conn));
                }
            } catch (Exception $e) {
...
<head>
  ...
  <title>Tambah Materi - Instruktur</title>
      ...
      <div class="container-fluid px-3 px-md-4">
        <div class="d-flex align-items-center">
          <div class="d-flex align-items-center flex-grow-1">
            ...
            <div class="page-info">
              <h2 class="page-title mb-1">TAMBAH MATERI</h2>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                    ...
                    <?php if ($kelasResult->num_rows > 0): ?>
                      <?php while($kelas = $kelasResult->fetch_assoc()): ?>
                        <option value="<?= $kelas['id_kelas'] ?>" 
                                <?= (isset($_POST['id_kelas']) && $_POST['id_kelas'] == $kelas['id_kelas']) || 
                                    ($preselected_kelas == $kelas['id_kelas']) ? 'selected' : '' ?>>
                ...
                <div class="mb-4">
                  ...
                  <div class="form-text">
                    <i class="bi bi-info-circle me-1"></i>
                    <small>Instruktur otomatis diisi dengan akun yang sedang login</small>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row mt-5 pt-4 border-top">
              <div class="col-12">
                <div class="d-flex justify-content-end gap-3">
                  <a href="index.php<?= !empty($preselected_kelas) ? '?kelas=' . $preselected_kelas : '' ?>" class="btn btn-kembali px-3">
                   Kembali
                  </a>
