                    ...
                    <tr>
                      ...
                      <td class="text-center align-middle" style="text-align: center !important;">
                          <?php if($instruktur['pas_foto'] && file_exists('../../../uploads/profile_pictures/'.$instruktur['pas_foto'])): ?>
                              ...
                              <a href="../../../uploads/profile_pictures/<?= $instruktur['pas_foto'] ?>" 
                                class="d-block" 
                                title="Download Foto <?= htmlspecialchars($instruktur['nama']) ?>"
                                download="Foto_<?= htmlspecialchars(str_replace(' ', '_', $instruktur['nama'])) ?>.jpg">
