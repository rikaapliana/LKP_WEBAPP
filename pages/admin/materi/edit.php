...
if (isset($_POST['ajax_check_duplicate'])) {
    ...
    // Cek duplikasi dengan join ke tabel kelas untuk mendapatkan nama kelas (exclude current materi)
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !isset($_POST['ajax_check_duplicate'])) {
    ...
    if (!isset($error)) {
        ...
        // Validasi duplikasi materi (judul + id_kelas harus unik jika kelas dipilih, exclude current materi)
