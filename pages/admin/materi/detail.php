...
// Ambil data materi dengan join ke tabel kelas, gelombang, dan instruktur
$query = "SELECT m.*, 
              ...
              <div class="row g-4">
                ...
                <div class="col-md-6">
                  <div class="info-item">
                    ...
                    <div class="fw-medium"><?= htmlspecialchars($materi['nama_instruktur'] ?? 'Belum ditentukan') ?></div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="info-item">
              ...
              <div class="mb-4">
                ...
                <?php if($materi['nama_instruktur']): ?>
                  <div class="text-center p-3">
                    ...
                    <h6 class="fw-bold mb-1"><?= htmlspecialchars($materi['nama_instruktur']) ?></h6>
                    <small class="text-muted">NIK: <?= htmlspecialchars($materi['nik_instruktur'] ?? '-') ?></small>
                  </div>
                <?php else: ?>
                  <div class="text-center p-3">
                    <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
